  ...
  const features = [
    {
      ...
      description: "Simply forward emails to your 401k Pro email address, and our system automatically categorizes and stores the touchpoint for compliance and reporting."
    },
    {
      icon: FileUp,
    ...
    },
    {
      ...
      description: "401k Pro enhances your existing systems rather than replacing them, handling tedious tasks while you focus on advising."
    }
  ];
